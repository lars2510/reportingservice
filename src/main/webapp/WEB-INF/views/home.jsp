...
<body>
		...
		<li class="categorie" data-type="monthSum">
			...
			<div class="subnav">
				<ul>
					...
					<li class="btn transportation" data-type="sumEcoImpact" data-unit="Gramm">Aufteilung auf Verkehrsmittel</li>
				</ul>
			</div>
		</li>
		<li class="categorie">
			...
			<div class="subnav">
				<ul>
					...
					<li class="btn transportation" data-type="sumCosts" data-unit="€">Aufteilung auf Verkehrsmittel</li>
				</ul>			
			</div>
		</li>
		<li class="categorie" data-type="transportation">
			...
			<div class="subnav">
				<ul>
					...
					<li class="btn transportation" data-type="sumDistance" data-unit="Kilometer">Aufteilung auf Verkehrsmittel</li>
				</ul>			
			</div>
		</li>
		<li class="categorie" data-type="transportation">
			...
			<div class="subnav">
				<ul>
					...
					<li class="btn transportation" data-type="sumTime" data-unit="Minuten">Aufteilung Verkehrsmittel</li>
				</ul>			
			</div>
		</li>
	</ul>
	...
	<div id="compare-container" style="min-width: 400px; height: 400px; margin: 0 auto; display: none;"></div>
	<p class="logout">
